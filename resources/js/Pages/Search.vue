...
<template>
    <AppLayout :show-reviews="true" :show-footer="true" :title="query === 'SUMMER SALE' ? 'Summer Sale - Atica' : 'Busqueda - Atica'">
        <div class="mt-5 py-5" id="destacados">
            <h2 v-if="query === 'SUMMER SALE'" class="d-block mt-5 text-center" style="font-size: 2.5rem">Summer Sale</h2>
            <h2 v-else class="d-block mt-5 text-center" style="font-size: 2.5rem">Resultados para "{{ query }}".</h2>
        </div>
