            ...
            <div class="bg-white shadow-sm rounded px-4 py-4">
                <form @submit.prevent="submit">
                    <div class="mb-3">
                        ...
                        <div v-if="form.errors.name" class="text-danger mt-2 small">{{ form.errors.name }}</div>
                    </div>
                    ...
                    <div class="mb-3">
                        ...
                        <div v-if="form.errors.password_confirmation" class="text-danger mt-2 small">{{ form.errors.password_confirmation }}</div>
                    </div>

                    <div class="d-flex align-items-center justify-content-between">
                        <Link href="/login" class="text-decoration-none small text-muted">
                            Already registered?
                        </Link>
