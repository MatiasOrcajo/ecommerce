 ...
 */
export async function renderSalesChart(routeToFetch = '/api/sales?filter=today') {
    ...
    salesChartInstance = new Chart(ctx, config); // Guardar la nueva instancia del gráfico
}
