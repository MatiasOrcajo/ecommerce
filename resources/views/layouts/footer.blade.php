...
<footer class="bg-dark text-white" style="{{Route::is('cart') || Route::is('order-success') ? 'margin-top: 22rem' : 'margin-top: 2rem'}}" id="footer">
    <div class="container pt-5 h-auto">
        ...
        <div class="row">
            ...
            <div class="col-12 col-md-4 mb-4">
                ...
                <ul class="list-unstyled">
                    <li class="mt-1"><a href="https://wa.link/3v3e29" target="_blank">11 7118 1308</a></li>
